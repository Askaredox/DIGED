                    ...
                    <?php foreach ($preguntas[0] as $key => $pre) : ?>
                        <div id="preg<?= ($key + 1) ?>">
                            <?php switch ($pre['tipo']):
                                ...
                                <?php break;
                                case 5: ?>
                                    <!--------------------- PARTE DE RESPUESTA SOPA DE LETRAS --------------------->
                                    <input id="preg_T<?= ($key + 1) ?>" value=<?= $pre['tipo'] ?> hidden>
                                    <div class="card mb-2">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col ">
                                <button type="button" class="btn btn-warning w-100" data-toggle="tooltip" data-placement="bottom" title="Sopa de letras" onclick=addP(5)>
                                    <i class="fas fa-plus"></i></br>
                                    Sopa
                                </button>
                            </div>
