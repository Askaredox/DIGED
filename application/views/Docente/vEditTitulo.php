...
<body id="page-top">
                        ...
                        <form class=" col-md-12 col-sm-12" name="RegisterTitle" id="RegisterTitle">
                            <div class="form-group" id="GroupCod">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <input type="text" class="form-control" name="Cod_Titulo" id="Cod_Titulo" placeholder="Codigo del Titulo" value="<?= $this->uri->segment(5) ?>" hidden>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group  col-md-12 col-sm-8" id="GroupName">
                                <?php if (isset($Nombre_Actual)) : ?>
                                    <label for="Nombre">Nombre Titulo</label>
                                    <input type="text" class="form-control" name="Nombre" id="Nombre" placeholder="<?= $Nombre_Actual ?>">
                            ...
                            <div class="form-group" id="GroupImg">
                                ...
                                <?php if (isset($img)) : ?>
                                    <div class="form-group  col-md-12 col-sm-8" id="GroupPos">
                                        <div class="row">
                                            <div class="col-6">
                                                    <input type="text" class="form-control" name="pos" id="pos"  placeholder="<?= isset($position)?$position:"posicion de enlace" ?>" value="<?= isset($position)?$position:"" ?>" readonly>
                                                    <div class="invalid-feedback">
                                                        Debe crear el area para redirigir al contenido del título
                                                    </div>
                                            </div>
                                            <div class="col-5">
                                                    <input type="text" class="form-control" name="tipo" id="tipo" placeholder="<?= isset($type)?$type:"enlace" ?>" value="<?= isset($type)?(($type == 1 ? "circular" : "rectangular")):"" ?>" readonly>
                                                    <div class="invalid-feedback">
                                                        Debe crear el area para redirigir al contenido del título
                                                    </div>
                                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="container">
                                        ...
                                        <textarea id="summernote" name="summernote" style="z-index:0; position:relative"></textarea>
        ...
        <?php foreach ($data as $titulo) : $title = $titulo["Nombre"] ?>
            ...
            <script type="text/javascript">
                ...
                if ($type == 1) {
                    ...
                    if($Coordenada=="<?php echo $position?>"){
                        //alert($Coordenada +"-"+" <//?php echo $position?>")
                        document.getElementById('mapeo').innerHTML += "<area   id=\"titulo\" class=\"title definitivo\" alt=\"\" href=\"#\" shape=\"circle\" coords=\"" + $enlace + "\" onclick=\"mostrarTitulo('<?php echo $title; ?>')\" data-maphilight=\'{\"alwaysOn\":true, \"fillColor\":\"#00ff00\"}\'>"
                    }else{
                    ...
                    if($Coordenada== "<?php echo $position?>"){
                    document.getElementById('mapeo').innerHTML += "<area  id=\"titulo\"  class=\"title definitivo\" alt=\"\" href=\"#\" shape=\"rect\" coords=\"" + $enlace + "\" onclick=\"mostrarTitulo('<?php echo $title; ?>')\" data-maphilight=\'{\"alwaysOn\":true, \"fillColor\":\"#00ff00\"}\'>"
                    }else{
    ...
    <script src=<?= base_url('assets/js/JEditTitle.js') ?>></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#summernote').summernote('code', '<?php echo isset($contenido) ? $contenido : '<p><br></p>' ?>');
